...
public class Charm
{
    ...
    public Charm()
    {
        ...
        {
            // else do that now
            File.WriteAllBytes(UnmanagedFileName, CharmGazzi.Properties.Resources.Charm_native);
        }
    }
    ...
    public class Renderer
    {
        ...
        private UnityEngine.Matrix4x4 pViewProj;
        ...
        public void SetViewProjection(UnityEngine.Matrix4x4 m_ViewProj)
        {
        ...
        public bool WorldToScreen(UnityEngine.Vector3 m_World, out UnityEngine.Vector3 m_Screen)
        {
            m_Screen = new UnityEngine.Vector3(0, 0, 0);
            float ScreenW = (this.pViewProj.m03 * m_World.x) + (this.pViewProj.m13 * m_World.y) + (this.pViewProj.m23 * m_World.z + this.pViewProj.m33);

            if (ScreenW < 0.0001f)
                return false;

            float Screenx = (this.pViewProj.m00 * m_World.x) + (this.pViewProj.m10 * m_World.y) + (this.pViewProj.m20 * m_World.z + this.pViewProj.m30);
            float Screeny = (this.pViewProj.m01 * m_World.x) + (this.pViewProj.m11 * m_World.y) + (this.pViewProj.m21 * m_World.z + this.pViewProj.m31);
